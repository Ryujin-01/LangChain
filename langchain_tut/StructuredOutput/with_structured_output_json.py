...
# This is how you define a structure using json.
# JSON is a global structure and can be used across every platform.
Review = {
    "title": "Review",
    "type": "object",
    "properties": {
    ...
    "required": ["key_themes", "summary", "sentiment", "pros", "cons", "name", "age"],
}
